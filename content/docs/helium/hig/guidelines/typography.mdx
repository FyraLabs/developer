...
- Use the system font wherever possible. tauOS uses Geist (by Vercel, with our own small changes) [[1]](https://github.com/FyraLabs/zeitgeist) at 11pt size.
...
![](/images/helium/hig/typography.png)
...
| Display                | <span style={{ fontWeight: 200 }}>Light 40px</span>             | `.display`               | Relatively large text on the screen, display is reserved for short, important text. |
| View Title             | <span style={{ fontWeight: 200 }}>Light 32px</span>              | `.view-title`            | Used for view titles, it's big enough to title an app's view.                       |
...
| Body                   | Regular 11px           | `.body` (is the default) | Used for all the text on the interface.                                             |
